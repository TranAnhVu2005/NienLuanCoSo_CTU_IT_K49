// Định nghĩa cấu trúc thông tin của 1 đối tượng phát hiện được từ AI (YOLOv8)
...
/**
 * Hàm gửi dữ liệu ảnh Base64 lên Server FastAPI chứa mô hình YOLOv8 để phân tích
