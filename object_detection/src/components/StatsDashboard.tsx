                    ...
                    <div className="relative flex items-center justify-center w-28 h-28">
                        ...
                        <svg className="w-full h-full transform -rotate-90">
                            ...
                            <circle
                                ...
                                cy="56"
                                r="48"
                                className={`transition-all duration-500 ${qualityScore >= 80 ? 'stroke-emerald-500' :
                        ...
                        <div className="absolute flex flex-col items-center justify-center">
                            ...
                            {totalCurrent > 0 && (
                                <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full mt-1 ${qualityScore >= 80 ? 'bg-emerald-500/20 text-emerald-400' :
                        ...
                        detections.map((det, index) => {
                            ...
                            return (
                                <div key={index} className="bg-gray-900/60 rounded-xl p-3 border border-gray-800 flex items-center justify-between hover:bg-gray-900 transition-colors">
                                    ...
                                    <span className={`text-xs font-mono font-bold px-2 py-1 rounded ${isRotten ? 'text-rose-400 bg-rose-400/10' : 'text-emerald-400 bg-emerald-400/10'
                                        }`}>
